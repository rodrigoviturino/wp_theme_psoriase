...
function ln_theme_styles(){
    ...
    // JAVASCRIPT
    wp_enqueue_script( "jquery_js", $directory . "/assets/js/lib/jquery-3.5.1.min.js", $version, false );
    wp_enqueue_script( "main_js", $directory . "/assets/js/main.js", $version, ["jquery_js"] , false);
}
